...
SHA256_DIGEST sha256(const void *message, std::size_t message_len);
void sha256_str(SHA256_DIGEST digest, char *str, std::size_t max_len);
int sha256_from_str(SHA256_DIGEST *out, const char *str);
int sha256_comp(SHA256_DIGEST digest1, SHA256_DIGEST digest2);

MD5_DIGEST md5(const void *message, std::size_t message_len);
void md5_str(MD5_DIGEST digest, char *str, std::size_t max_len);
